    ...
    <script type="text/javascript">
        ...
        $(function (){
            ...
            $("#yzmCode").click(function (){
                $("#yzmCode").attr("src","userServlet?method=managerCode&n="+Math.random());
            });
            //对验证码进行确定
            $("#verifycode")
        });
...
<div id="content">
    <div class="login_form" align="center">
        <div class="login_box" align="center">
            <!-- 头部信息 -->
            <br class="tit">
            <h1 style="color: white">MyWeChat管理员后台登陆</h1>
            <span class="login_msg" style="color: red"  font-size: 20px>${ empty requestScope.msg1 ? "请输入用户名和密码":requestScope.msg1 }</span>
        </div>
        <br/>
        <!-- 中部form表单 -->
        <div class="form">
            <form action="userServlet?method=managerLogin" method="post">
                ...
                <img src="userServlet?method=managerCode" id="yzmCode" class="yzm" height="30px" width="100px"/>
                <br/>
                <br/>
