    ...
    <div class="login_form" align="center">
        ...
        <div class="form">
            <form action="userServlet?method=travelLogin" method="post">
                ...
                <img src="userServlet?method=travelCode" id="yzmCode" class="yzm" height="30px" width="100px"/>
                <br/>
                <br/>
